...
Hashicorp does not recommend using them. Configuration Managment tools such as Ansible should be used to manage configuration.
...
This will execute commands on a targeted machine. You will need to provide credentials for the remote machine.
